...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-electric to-neon text-white hover:shadow-lg hover:shadow-electric/50",
        destructive: "bg-red-500 text-white hover:bg-red-600",
        outline: "border-2 border-glass-border bg-glass-white backdrop-blur-xl text-white hover:bg-glass-border",
        secondary: "bg-nebula text-white hover:bg-fog",
        ghost: "hover:bg-glass-white hover:text-white",
